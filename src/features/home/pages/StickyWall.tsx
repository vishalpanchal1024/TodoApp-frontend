...
const StickyWall:FC = ():ReactElement => {
  ...
  return (
    <div className="w-full min-h-[80vh] border-2 border-gray-200 rounded-xl grid grid-cols-1 sm:grid-col-2 md:grid-cols-3 xl:grid-cols-4 gap-4 p-4 select-none" >
      <div onClick={()=>setShowModal(true)} className="h-52 bg-gray-200 rounded-lg flex items-center justify-center cursor-pointer" >
        <img src="/svg/plus.svg"  className="size-20" />
      </div>
