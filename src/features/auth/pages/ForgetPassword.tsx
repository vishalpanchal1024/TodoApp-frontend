...
const ForgetPassword: FC = (): ReactElement => {
    return (
            ...
            <form className='w-[80%]'>
                ...
                <h4 className="text-sm text-gray-500 font-semibold mb-6"> Enter your email to receive a reset password link. </h4>
                ...
                <p className='text-center font-medium py-2' >Back to login <Link to="/login" className='text-blue-500 cursor-pointer' >Log in</Link></p>
            </form>
